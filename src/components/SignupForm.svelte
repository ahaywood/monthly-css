...
<form
  ...
  action="https://kwesforms.com/api/foreign/forms/PkXe0oDAxecGYhJDkJbb"
>
  ...
  <div class="field flex items-end">
    <button
      type="submit"
      class="mt-auto text-sm xl:text-base w-full border-2 border-white hover:border-pantoneOrange hover:bg-pantoneOrange h-16 font-wide uppercase tracking-widening"
      >Sign me up for <span class="text-pantoneOrange">FREE</span></button
    >
  </div>
  ...
  <div class="field col-span-3 pt-6">
    <div class="field flex items-center gap-x-2">
      ...
      >
        Receive
        <a
          href="https://monthlyjs.com"
          class="underline font-bold hover:text-pantoneOrange"
          target="_blank"
          rel="noopener noreferrer">Monthly JS</a
        > Challenges (in addition to Monthly JS challenges).
      </label>
    </div>
  </div>
</form>
...
<style lang="postcss">
  ...
  input[type="text"],
  input[type="email"] {
    @apply px-6 bg-transparent border-2 border-white h-16 w-full focus:border-pantoneOrange outline-none text-xl;
  }
